      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
        {items.map((item) => (
          <GlassCard 
            ...
            opacity={40}
          >
            <div className="aspect-[4/3] relative overflow-hidden border-b border-white/10 bg-black/20 cursor-pointer" onClick={() => onSelect(item)}>
              <GlassImage 
                src={item.imageUrl} 
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-2">
                  ...
                  <span className={`text-[9px] px-2 py-0.5 rounded-full border font-black ${
                      item.recipe.difficulty === 'Beginner' ? 'border-green-500/30 text-green-400 bg-green-500/10' :
